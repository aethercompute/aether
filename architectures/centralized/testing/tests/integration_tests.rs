...
#[test_log::test]
fn state_change_waiting_for_members_to_warmup() {
    run_test(async {
...
#[test_log::test]
fn state_change_shutdown_node_in_warmup() {
    run_test(async {
        // Coordinator is initialized with some default values
        let init_min_clients = 2;
        let global_batch_size = 4;
...
#[test_log::test]
fn state_change_waiting_for_members_to_round_train() {
    run_test(async {
        // Coordinator is initialized with some default values
        let init_min_clients = 2;
        let global_batch_size = 4;
...
#[test_log::test]
fn state_change_waiting_for_members_to_round_witness() {
    run_test(async {
        let init_min_clients = 2;
        let global_batch_size = 4;
        let witness_nodes = 1;
...
#[test_log::test]
fn validate_all_clients_participate_in_witness_bloom() {
    run_test(async {
...
#[test_log::test]
fn replace_node_and_complete_round() {
    run_test(async {
        let init_min_clients = 2;
